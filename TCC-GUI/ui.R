...
dashboardPage(
  ...
  dashboardSidebar(
    ...
    helpText("Copyright (c)2018 Bioinformation Engineering Lab, The University of Tokyo, All Rights Reserved. v2018.11.29", 
  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "pcaHelp", box(title = "Exploratory analysis (PCA)",
                                       solidHeader = TRUE,
                                       width = NULL,
                                       status = "info",
